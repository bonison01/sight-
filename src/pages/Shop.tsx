...
const Shop = () => {
  ...
  const fetchProducts = async () => {
    try {
      const { data, error } = await supabase
        .from('products')
        .select(
          'id, name, price, offer_price, image_url, description, category, is_active, stock_quantity'
        )
        .eq('is_active', true)
  ...
  const renderProductCard = (product: Product) => {
    ...
    return (
      <div
        key={product.id}
        className="bg-white rounded-xl border border-blue-100 shadow-md hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
      >
        ...
        <div className="p-4">
          <h3 className="text-blue-900 text-lg font-semibold mb-1 line-clamp-1">
            {product.name}
          </h3>
          ...
          <div className="flex items-center justify-center space-x-2 mb-4">
            <Button
              ...
              className="h-8 w-8 p-0 border-blue-300 hover:bg-blue-50 text-blue-700"
            >
          ...
          {loading ? (
            ...
            <>
              <div className="text-center mb-12">
                ...
                <p className="text-blue-700 mb-4 max-w-2xl mx-auto">
                  Choose from our selection of {filteredProducts.length} premium
                  products
                </p>
              </div>
            ...
            <div className="text-center py-24">
              ...
              <p className="text-blue-700 mb-8 max-w-md mx-auto">
                Try adjusting your search or filter — we’re always adding new
                items!
              </p>
              <Button
                onClick={() => {
